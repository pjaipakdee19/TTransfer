...
namespace AutoTintLibrary
{
    ...
    {
        public static string baseURL = (File.Exists(@"C:\ProgramData\TOA_Autotint\config.json")) ? (ManageConfig.ReadGlobalConfig("base_url") != null) ? ManageConfig.ReadGlobalConfig("base_url") : "http://49.229.21.9/dev" : "http://49.229.21.9/dev";
